  ...
  return (
    <html lang="en">
      ...
      <body style={{ margin:0,padding:0,fontFamily:'system-ui' }}>
        <EmbedBridge />
        <div data-app-chrome style={{ background:'rgba(0,0,0,0.88)',padding:'6px 20px',display:'flex',alignItems:'center',justifyContent:'space-between',position:'sticky',top:0,zIndex:9999 }}>
